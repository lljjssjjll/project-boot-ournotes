...
INSERT INTO `app`.`user` (`id`,`create_date`,`modify_date`,`flag`,`email`,`enc_password`,`nickname`,`sex`,`phone`,`name`)
VALUES (2,now(),now(),1,'user01@jslee.com','$2a$10$PrI5Gk9L.tSZiW9FXhTS8O8Mz9E97k2FZbFvGFFaSsiTUIl.TCrFu','사용자01','M','010-2222-3333','이혜정');
INSERT INTO `app`.`user` (`id`,`create_date`,`modify_date`,`flag`,`email`,`enc_password`,`nickname`,`sex`,`phone`,`name`)
VALUES (3,now(),now(),1,'user02@jslee.com','$2a$10$PrI5Gk9L.tSZiW9FXhTS8O8Mz9E97k2FZbFvGFFaSsiTUIl.TCrFu','사용자02','F','010-3333-4444','이진영');
